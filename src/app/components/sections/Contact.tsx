import { Phone, MessageCircle, MapPin, Clock, Send, Facebook, Instagram } from 'lucide-react';
...
const socialLinks = [
  { icon: Instagram, href: 'https://instagram.com/artedental_lr', label: '@artedental_lr' },
  { icon: Facebook, href: 'https://facebook.com/artedental.lr', label: '/artedental.lr' },
];
